...
```json
{
  ...
  "properties": {
    ...
    "payload": {
      "type": "object",
      "required": ["loop_id", "started_from", "decision"],
      "properties": {
        ...
        "started_from": {
          "type": ["string", "null"],
          "enum": ["navigate", "reason", "realize", "validate", null],
          "description": "Previous loop's ending phase (null for first loop)"
        },
        "decision": {
          "type": ["string", "null"],
          "enum": ["continue", "adjust", "pivot", null],
          "description": "Outcome from previous loop (null for first loop)"
        }
      }
    }
  }
...
```json
{
  ...
  "properties": {
    ...
    "payload": {
      "type": "object",
      "required": ["loop_id", "from_phase", "to_phase", "acknowledged_warnings"],
      "properties": {
        "loop_id": { "type": "integer", "minimum": 1 },
        "from_phase": {
          "type": "string",
        ...
        "acknowledged_warnings": {
          "type": "array",
          "items": { "type": "string" },
          "description": "Warning IDs that were acknowledged for this transition"
        }
      }
    }
  }
...
```json
{
  ...
  "properties": {
    ...
    "payload": {
      "type": "object",
      "required": ["loop_id", "warning_id", "reason", "phase"],
      "properties": {
        "loop_id": { "type": "integer", "minimum": 1 },
...
```json
{
  ...
  "properties": {
    ...
    "payload": {
      "type": "object",
      "required": ["spec", "phase", "summary", "by_status", "by_type", "gaps"],
      "properties": {
        "spec": { "type": "string" },
        "phase": { "type": "string" },
        "summary": {
        ...
        "by_status": {
          "type": "object",
          "required": ["pending", "implemented", "passing", "failing"],
          "properties": {
